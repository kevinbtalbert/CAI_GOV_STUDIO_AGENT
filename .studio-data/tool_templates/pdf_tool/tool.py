...
class md2pdf(StudioBaseTool):
    ...
    def _run(self, action: str, pdf: str, raw: Optional[str] = None, md: Optional[str] = None, css: Optional[str] = None, base_url: Optional[str] = None, extras: Optional[List[str]] = None) -> str:
        try:
            if action == "readpdf":
